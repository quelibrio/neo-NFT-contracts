 ...
 */
export declare function addAttributeForMintToken(config: DoInvokeConfig): Promise<DoInvokeConfig>;
/**
 * Adds the contractState to mintTokens invocations.
 * @param {object} config - Configuration object.
 * @return {Promise<object>} Configuration object.
 */
export declare function addSignatureForMintToken(config: DoInvokeConfig): Promise<DoInvokeConfig>;
